...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_BinaryClassificationEvaluator_find_best_f1_and_threshold(self):
        ...
        y_pred_labels = [1 if pred >=
                         threshold else 0 for pred in y_pred_cosine]
    ...
    def test_LabelAccuracyEvaluator(self):
        ...
        if not os.path.exists(nli_dataset_path):
            util.http_get(
                'https://sbert.net/datasets/AllNLI.tsv.gz', nli_dataset_path)
    ...
    def test_ParaphraseMiningEvaluator(self):
        ...
        model = SentenceTransformer('paraphrase-distilroberta-base-v1')
        sentences = {0: "Hello World", 1: "Hello World!",
                     2: "The cat is on the table", 3: "On the table the cat is"}
